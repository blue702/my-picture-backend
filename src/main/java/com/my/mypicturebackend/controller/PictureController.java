...
import com.my.mypicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.my.mypicturebackend.api.imagesearch.ImageSearchApiFacade;
...
import com.my.mypicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = "mypicture:listPictureVOByPage:" + hashKey;
        ...
        // 4. 更新缓存
        // 这里不管 picturePage 是否为空，都存入缓存，防止缓存穿透
        // 存入 Redis 缓存
    ...
    /**
     * 以图搜图
     * todo 百度搜图接口有时不支持webp，后续上传图片时保留原图url
     */
