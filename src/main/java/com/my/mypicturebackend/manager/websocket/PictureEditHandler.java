...
import com.my.mypicturebackend.manager.disruptor.PictureEditEventProducer;
import com.my.mypicturebackend.manager.websocket.model.PictureEditActionEnum;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        // 只在键不存在时才插入新值
        // 如果键已存在，则不会替换现有值
        // 返回值：如果键不存在则返回 null，如果键存在则返回现有的值
